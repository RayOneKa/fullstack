    ...
    <body>
        <div class = 'container mt-5'>
           <form enctype="multipart/form-data" action="actions/edit_category.php" method="post">
               ...
               <input required class="form-control mb-2" name ='name_new' placeholder="измените имя категории" value="<?=$categories['name']?>">
               <textarea required class="form-control mb-2" name ='description_new' row = '3' placeholder="Измените описание категории"><?=$categories['description']?></textarea>
